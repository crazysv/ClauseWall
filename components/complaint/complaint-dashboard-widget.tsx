        ...
        <CardContent className="p-5">
          ...
          <div className="grid grid-cols-3 gap-3 mb-4">
            ...
            <div className="text-center p-2 rounded-lg bg-blue-500/10">
              <p className="text-lg font-bold text-blue-400">{filings.length}</p>
          ...
          {active.slice(0, 3).map(filing => (
            <Link key={filing.id} href={`/complaint/${filing.document_id}`}>
              <div className="flex items-center justify-between py-2 border-t border-white/5 hover:bg-white/[0.02] px-1 rounded transition-colors cursor-pointer">
                ...
                <span className={`text-[10px] font-medium ${statusColors[filing.status] || 'text-gray-400'}`}>
