  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-6 border-b-4 border-black pb-3">
        ...
        <h3 className="font-black text-lg uppercase tracking-widest text-black">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <div className="p-3 bg-white border-4 border-black text-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          ...
          <p className="text-[10px] font-bold uppercase tracking-widest text-black mt-1">
            States
          </p>
        </div>
        <div className="p-3 bg-white border-4 border-black text-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div
          className={`p-3 border-4 border-black text-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] ${report.trapAnalysis.length > 0 ? "bg-red-100" : "bg-green-100"}`}
        >
          <p className={`text-2xl font-black text-black`}>
        ...
        <div
          className={`p-3 border-4 border-black text-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] bg-white`}
        >
