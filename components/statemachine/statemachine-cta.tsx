    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className={`p-3 border-2 border-black bg-white shadow-[2px_2px_0_0_rgba(0,0,0,1)]`}>
          ...
          <div>
            <h4 className="text-sm font-black uppercase tracking-widest text-black mb-1">
              ...
              {trapCount > 0 && (
                <span className="text-red-900">and {trapCount} Trap{trapCount > 1 ? "s" : ""}</span>
              )}
            </h4>
            <p className="text-xs font-bold text-black/70">
              See how your contract executes over time and where you could get trapped.
            </p>
            <p className="text-[10px] font-black uppercase tracking-widest text-black/40 mt-1">Find hidden trap paths in your contract&apos;s timeline</p>
          </div>
        </div>
