      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 h-full">
        <div className="flex h-full items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8 overflow-x-auto no-scrollbar">
            <Link href="/upload">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/upload') || isActive('/results'))}>
                <Upload className="h-4 w-4" />
                Analyze
              </Button>
            </Link>
            <Link href="/builder">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/builder'))}>
                <Hammer className="h-4 w-4" />
                Builder
              </Button>
            </Link>
            <Link href="/compare">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/compare'))}>
                <ArrowLeftRight className="h-4 w-4" />
                Compare
              </Button>
            </Link>
            <Link href="/vault">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/vault'))}>
                <FileStack className="h-4 w-4" />
                Vault
              </Button>
            </Link>
            <Link href="/dashboard">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/dashboard'))}>
                <BarChart3 className="h-4 w-4" />
                Dashboard
              </Button>
            </Link>
            <Link href="/wall-of-shame">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/wall-of-shame'))}>
                <Skull className="h-4 w-4" />
                Wall of Shame
              </Button>
            </Link>
            <Link href="/collective">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/collective'))}>
                <Users className="h-4 w-4" />
                Collectives
              </Button>
            </Link>
            <Link href="/negotiate/live">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/negotiate/live'))}>
                <Handshake className="h-4 w-4" />
                Negotiate
              </Button>
            </Link>
            <Link href="/lawchange">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/lawchange'))}>
                <Scale className="h-4 w-4" />
                Law Monitor
              </Button>
            </Link>
            <Link href="/voice">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/voice'))}>
                <Mic className="h-4 w-4" />
                Voice Aid
              </Button>
            </Link>
            <Link href="/complaint">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/complaint'))}>
                <Gavel className="h-4 w-4" />
                Complain
              </Button>
            </Link>
            <Link href="/shadow">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/shadow'))}>
                <FileSearch className="h-4 w-4" />
                Shadow
              </Button>
            </Link>
            <Link href="/watchdog">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/watchdog'))}>
                <Eye className="h-4 w-4" />
                Watchdog
              </Button>
            </Link>
            <Link href="/evidence">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/evidence'))}>
                <Shield className="h-4 w-4" />
                Evidence
              </Button>
            </Link>
            <Link href="/market">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/market'))}>
                <TrendingUp className="h-4 w-4" />
                Market
              </Button>
            </Link>
            <Link href="/authority">
              <Button variant="ghost" size="sm" className={getDesktopNavClass(isActive('/authority'))}>
        ...
        {mobileOpen && (
          <div className="lg:hidden bg-background border-b-2 border-foreground/10 absolute left-0 right-0 top-16 shadow-lg pb-4 max-h-[80vh] overflow-y-auto z-40">
            ...
            <Link href="/upload" onClick={() => setMobileOpen(false)} className={getMobileNavClass(isActive('/upload') || isActive('/results'))}>
            ...
            <Link href="/dashboard" onClick={() => setMobileOpen(false)} className={getMobileNavClass(isActive('/dashboard'))}>
