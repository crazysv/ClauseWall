  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        className={`fixed bottom-24 right-6 z-50 w-14 h-14 rounded-none border-4 border-foreground shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex items-center justify-center transition-all ${isListening
