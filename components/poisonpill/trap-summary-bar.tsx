...
export function TrapSummaryBar({ result }: Props) {
  ...
  return (
    ...
    >
      {/* Combined Trap Score */}
      <div className="bg-white/[0.03] border border-foreground border-2 rounded-none p-3 flex items-center gap-3">
        <svg
          width="50"
          height="50"
          viewBox="0 0 50 50"
      ...
      {/* Severity Breakdown */}
      <div className="bg-white/[0.03] border border-foreground border-2 rounded-none p-3">
      ...
      <div className="bg-white/[0.03] border border-foreground border-2 rounded-none p-3">
        ...
        <p className="text-lg font-bold text-foreground">{trap_density}%</p>
        <p className="text-[10px] text-foreground">of clauses involved</p>
      </div>
