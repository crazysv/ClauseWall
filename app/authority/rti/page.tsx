      ...
      <main role="main" className="flex-1 w-full max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16 space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
        <div className="text-center max-w-2xl mx-auto space-y-4">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 font-medium leading-relaxed">
            ...
            Every Indian citizen has the right to get information from public authorities within <span className="font-bold text-slate-900 dark:text-slate-200">30 days</span>.
          </p>
        </div>
