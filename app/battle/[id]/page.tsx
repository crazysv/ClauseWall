  ...
  if (error || !doc) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 bg-white border-2 border-black p-8 m-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        ...
        <Link href="/upload">
          <Button className="border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] font-bold uppercase hover:translate-y-1 hover:shadow-none transition-all rounded-none px-6">
            UPLOAD CONTRACT
          </Button>
        </Link>
      </div>
        ...
        <Card className="border-2 border-black rounded-none shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] bg-white">
          <CardContent className="p-10 text-center">
            ...
            <p className="text-sm font-bold text-muted-foreground leading-relaxed max-w-md mx-auto mb-6">
              ...
              contracts to show meaningful comparisons. Currently we have{" "}
            ...
            <p className="text-xs font-black uppercase tracking-widest text-blue-800 bg-blue-100 p-4 border-2 border-blue-900 mb-8 mx-auto max-w-md">
              Help us grow! Share ClauseWall with friends who have contracts to
              analyze.
            </p>
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 max-w-4xl mx-auto">
      ...
      <div className="mb-10">
        ...
        <p className="text-muted-foreground font-bold uppercase tracking-widest">
          ...
          vs{" "}
          <span className="text-black">
            {scope === "state" ? getStateName(doc.jurisdiction) : "All India"}
          </span>{" "}
          average
        </p>
      </div>
      ...
      {!battleLoading && activeData && (
        <>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-8">
                  ...
                  <div className="text-center sm:text-left flex-1">
                    ...
                    <p className="text-sm font-bold text-muted-foreground mb-4 leading-relaxed">
                      ...
                      <span className="text-black uppercase">
                        {scope === "state"
                          ? `in ${getStateName(doc.jurisdiction)}`
                          : "across India"}
                      </span>
                    </p>
                    ...
                    <p
                      className="text-lg font-black uppercase tracking-widest mt-6 border-t-2 border-black/10 pt-4"
                      style={{
                        color:
                          activeData.overallPercentile >= 75
                            ? "#7e22ce"
                ...
                <div className="mt-8 pt-6 border-t-2 border-black/10">
                  ...
                  <div className="h-6 border-2 border-black bg-gray-100 relative shadow-[inset_2px_2px_0px_0px_rgba(0,0,0,0.1)]">
                    ...
                    <motion.div
                      ...
                      initial={{ left: "0%" }}
                      animate={{
                        left: `${Math.min(Math.max(activeData.overallPercentile, 1), 99)}%`,
                      }}
          ...
          {/* Value Comparisons */}
          {hasValueComparisons &&
            battleData!.comparisons.map((comp, index) => (
              <motion.div
                key={comp.clauseType}
            ...
            <>
              ...
              {battleScores.scoreComparisons
                .filter(
                  (sc) =>
                    !hasValueComparisons ||
                    !battleData!.comparisons.find(
                      (c) => c.clauseType === sc.clauseType,
                    ),
                )
                .map((comp, index) => (
                  <motion.div
                ...
                <CardContent className="p-8">
                  ...
                  <ul className="space-y-4">
                    {activeData.insights.map((insight, i) => (
                      <li
                        key={i}
                        className="text-sm border-2 border-blue-900 bg-white p-4 font-bold text-black leading-relaxed shadow-[4px_4px_0px_0px_rgba(30,58,138,0.2)]"
                      >
                        {insight}
                      </li>
                    ))}
      ...
      <CardContent className="p-6 sm:p-8">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {comp.severity === "critical"
                ...
                : comp.severity === "worse"
                  ? "🔴"
                  : comp.severity === "average"
                    ? "🟡"
                    : "✅"}{" "}
              P{comp.percentile}
            </span>
            <span className="text-xs font-bold uppercase tracking-widest bg-gray-100 border-2 border-black px-3 py-1.5 text-black">
        ...
        <div className="space-y-4 pr-10">
          ...
          <div className="flex items-center gap-4">
            <span className="text-xs font-black uppercase tracking-widest text-black w-24 flex-shrink-0">
              YOUR TERMS
            </span>
            <div className="flex-1 h-8 bg-gray-100 border-2 border-black rounded-none relative">
              <motion.div
                ...
                style={{
                  backgroundColor:
                    RISK_BAR_COLORS[comp.yourRiskLevel] || "#ef4444",
                }}
                initial={{ width: 0 }}
          ...
          {comp.legalLimit != null && (
            <div className="flex items-center gap-4">
              <span className="text-xs font-black uppercase tracking-widest text-green-700 w-24 flex-shrink-0">
                LEGAL LIMIT
              </span>
              <div className="flex-1 h-8 bg-green-50 border-2 border-green-700 border-dotted rounded-none relative">
                <motion.div
                  ...
                  initial={{ width: 0 }}
                  animate={{
                    width: `${Math.max(comp.legalLimit * scale, 1)}%`,
                  }}
  ...
  return (
    <Card className="border-2 border-black rounded-none bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] mb-4">
      <CardContent className="p-6">
        ...
        <div className="space-y-4 pr-10">
          <div className="flex items-center gap-4">
            <span className="text-[11px] font-black uppercase tracking-widest text-black w-16 flex-shrink-0">
              YOURS
            </span>
