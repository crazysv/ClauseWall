    ...
    return (
      <div className="min-h-screen bg-background p-4 sm:p-8 max-w-7xl mx-auto px-4 md:px-6 pt-12 md:pt-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-6">
          {[1, 2, 3, 4].map(i => (
            <Skeleton key={i} className="h-28 rounded-lg bg-muted border-2 border-foreground shadow-[8px_8px_0px_0px_rgba(10,10,10,1)]" />
          ))}
        </div>
        <Skeleton className="h-10 w-full rounded-lg mb-4 bg-muted border-2 border-foreground" />
        <div className="space-y-3">
          {[1, 2, 3, 4, 5].map(i => (
            <Skeleton key={i} className="h-16 rounded-lg bg-muted border-2 border-foreground shadow-[4px_4px_0px_0px_rgba(10,10,10,1)]" />
          ))}
        </div>
      </div>
    );
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 pt-12 md:pt-20">
          <div className="text-center py-20 card-impact border-2 border-foreground shadow-[12px_12px_0px_0px_rgba(10,10,10,1)] rounded-lg p-10 mt-10">
            ...
            >
              ...
              <h2 className="text-impact-heading text-foreground mb-3">Your Contract Portfolio</h2>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <Link href="/builder">
                  <Button variant="outline" className="button border-2 border-foreground hover:bg-muted font-bold uppercase tracking-wider shadow-[4px_4px_0px_0px_rgba(10,10,10,1)] hover:-translate-y-[2px] transition-all gap-2 py-6 text-lg">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 pt-12 md:pt-20 pb-8">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            <Link href="/builder">
              <Button variant="outline" size="sm" className="button border-2 border-foreground hover:bg-muted font-bold uppercase tracking-wider shadow-[4px_4px_0px_0px_rgba(10,10,10,1)] hover:-translate-y-[2px] transition-all gap-2 py-5 px-6 hidden sm:flex">
                <Sparkles className="h-4 w-4 text-amber-500" />
                Build
              </Button>
            </Link>
            <Link href="/upload">
              <Button size="sm" className="button text-impact-heading border-2 border-foreground shadow-[4px_4px_0px_0px_rgba(10,10,10,1)] hover:-translate-y-[2px] transition-all gap-2 py-5 px-6">
            ...
            <CardContent className="relative p-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="text-xl font-black uppercase tracking-wider text-foreground">Live Negotiation Companion</h3>
                      <Badge className="bg-blue-500 text-foreground border-2 border-foreground font-black uppercase shadow-[2px_2px_0px_0px_rgba(10,10,10,1)] px-2 animate-pulse">NEW</Badge>
                    </div>
                    <p className="text-sm font-bold text-blue-900">Real-time legal intelligence for in-person negotiations</p>
                  </div>
                </div>
          ...
          <div className="divide-y-2 divide-foreground">
            {filteredDocuments.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 px-4 bg-background">
                ...
                {searchQuery || filterType !== 'all' ? (
                  <>
                    <p className="text-sm font-black uppercase text-foreground mb-1">No matching documents</p>
                    <p className="text-xs font-bold text-muted-foreground mb-4">Try adjusting your search or filters</p>
                    <button
                  ...
                  <>
                    <p className="text-sm font-black uppercase text-foreground mb-1">No contracts analyzed yet</p>
                    <p className="text-xs font-bold text-muted-foreground mb-4">Upload your first contract to get started</p>
                    <Link
                      href="/upload"
                  ...
                  <div className="p-4 sm:p-5">
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-4 min-w-0 flex-1">
                        <div
                          className="h-12 w-12 border-2 border-foreground flex items-center justify-center flex-shrink-0 bg-background shadow-[2px_2px_0px_0px_rgba(10,10,10,1)]"
                        >
                          <span
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <span className={`text-xs font-black uppercase tracking-wider px-2 py-0.5 border-2 border-current bg-background ${textColor}`}>
