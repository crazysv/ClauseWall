      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-2 flex-wrap">
            ...
            <span className="text-sm text-muted-foreground">vs {campaign.company?.name}</span>
          </div>
          ...
          <CardContent className="p-5">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-2xl font-bold text-amber-400">{campaign.signatory_count}</span>
                <span className="text-muted-foreground">/ {campaign.target_count} signatories</span>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            <Card className="bg-gray-900/50 border-gray-800">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">{campaign.legal_basis}</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-900/50 border-gray-800">
              ...
              <CardContent>
                {typedSignatories.length === 0 ? (
                  <p className="text-sm text-muted-foreground">No signatories yet. Be the first!</p>
                ) : (
                  <div className="space-y-2 max-h-60 overflow-y-auto">
                    {typedSignatories.map((sig) => (
                      <div key={sig.id} className="flex items-center justify-between py-1.5 text-sm">
