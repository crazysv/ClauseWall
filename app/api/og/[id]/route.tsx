...
const THEMES = {
  ...
  warning: { bg: "#78350f", accent: "#eab308", label: "MEDIUM RISK", emoji: "⚠️" },
  dangerous: { bg: "#7f1d1d", accent: "#ef4444", label: "HIGH RISK", emoji: "🔴" },
  illegal: { bg: "#3b0764", accent: "#a855f7", label: "CRITICAL RISK", emoji: "⛔" },
};
