// ============================================
// POST /api/poisonpill/reanalyze
// Force re-analysis of poison pills for a document
// ============================================
...
export async function POST(request: Request) {
  try {
    ...
    const { data: document, error: docError } = await supabase
      .from("documents")
      .select("id, analysis_status, document_type, jurisdiction, entity_name")
      .eq("id", document_id)
      .single();
    ...
    // Run fresh analysis (ignore cached results)
