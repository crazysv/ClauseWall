    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-foreground text-background flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="max-w-md relative z-10 w-full">
          <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter leading-tight text-background mb-12 text-center">
            LEGAL POWER<br/>FOR EVERYONE.
          </h2>
          
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-background/10 border-2 border-background p-6">
              <p className="text-4xl font-black text-primary drop-shadow-[2px_2px_0px_background]">750+</p>
              <p className="text-sm font-black uppercase tracking-wider mt-2 text-background/80">Contracts Found Illegal</p>
            </div>
            <div className="bg-background/10 border-2 border-background p-6">
              <p className="text-4xl font-black text-primary drop-shadow-[2px_2px_0px_background]">10+</p>
              <p className="text-sm font-black uppercase tracking-wider mt-2 text-background/80">Languages Supported</p>
            </div>
            <div className="bg-background/10 border-2 border-background p-6 col-span-2 text-center">
              <p className="text-4xl font-black text-primary drop-shadow-[2px_2px_0px_background]">100%</p>
              <p className="text-sm font-black uppercase tracking-wider mt-2 text-background/80">Privacy Guaranteed. We Don't Sell Your Data.</p>
            </div>
          </div>
        </div>
      </div>
