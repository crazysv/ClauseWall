        ...
        <div className="max-w-md relative z-10 w-full">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-background/10 border-2 border-background p-6">
              <p className="text-4xl font-black text-primary drop-shadow-[2px_2px_0px_background]">
                750+
              </p>
              <p className="text-sm font-black uppercase tracking-wider mt-2 text-background/80">
                Contracts Found Illegal
              </p>
            </div>
            <div className="bg-background/10 border-2 border-background p-6">
              <p className="text-4xl font-black text-primary drop-shadow-[2px_2px_0px_background]">
            ...
            <div className="bg-background/10 border-2 border-background p-6 col-span-2 text-center">
              ...
              <p className="text-sm font-black uppercase tracking-wider mt-2 text-background/80">
                Privacy Guaranteed. We Don't Sell Your Data.
              </p>
            </div>
          </div>
        </div>
